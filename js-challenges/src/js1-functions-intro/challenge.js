...
export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
  ...
  const totalNumOfSnickers = (maxAge - age) * snickersPerDay * 365;

  return Number(totalNumOfSnickers);
};
...
export const getStudentSummary = (score, name) => {
  ...
  switch (true) {
    case getGrade(score) === "Score unavailable":
